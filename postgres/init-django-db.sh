...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "$POSTGRES_DB" <<-EOSQL
	...
	CREATE DATABASE test_POSTGRES_DJANGO_DB;
	GRANT ALL PRIVILEGES ON DATABASE POSTGRES_DJANGO_DB TO POSTGRES_DJANGO_USER;
	GRANT ALL PRIVILEGES ON DATABASE test_POSTGRES_DJANGO_DB TO POSTGRES_DJANGO_USER;
	ALTER DATABASE POSTGRES_DJANGO_DB OWNER TO POSTGRES_DJANGO_USER;
	ALTER DATABASE test_POSTGRES_DJANGO_DB OWNER TO POSTGRES_DJANGO_USER;
